      ...
      <form className='text-light mt-5' onSubmit={submitForm}>
        <Row>
          <Col className='position-relative'>
            ...
            {usernameHasError &&
              (<p className='text-danger'>username must be more than 5 letters include upperCaseLetters & lowerCaseLetters .</p>
              )}
         ...
         <Row>
          <Col  >
            ...
            <div className='position-relative'>
              ...
              {passwordHasError &&
              (<p className='text-danger'>password must be more than 8 numbers include upperCaseLetters & lowerCaseLetters & numbers.</p>)}
